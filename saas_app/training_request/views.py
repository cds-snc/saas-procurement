...
from .forms import SubmitTrainingForm 
...
def process_requests(request):
    if request.method == "POST":
        form = SubmitTrainingForm(request.POST) 
        if form.is_valid():
            ...
            messages.success(request, _("Your training form was submitted successfully!"))
